...
--disk path=/var/lib/libvirt/images/$VMNAME.qcow2,size=10,format=qcow2,bus=ide,cache=none --network=bridge:br0 \
--network=bridge:br0 --network=bridge:br0 --accelerate --vnc --noautoconsole --keymap=en-us --pxe \
--boot=network,hd"
